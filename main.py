    ...
    if tipo_analise == 'Q':
        ...
        # Mantém a lógica atual da análise léxica
        pass

    elif tipo_analise == '2':
        print("\n[INFO] Iniciando análise sintática...")
        # Aqui você pode chamar sua função de análise sintática
        # Exemplo fictício:
        # resultado_sintatico = analisar_sintaticamente(codigo_para_analise)
        # print(resultado_sintatico)
        continue

    elif tipo_analise == '3':
        print("\n[INFO] Iniciando análise semântica...")
        # Aqui você pode chamar sua função de análise semântica
        # Exemplo fictício:
        # resultado_semantico = analisar_semanticamente(codigo_para_analise)
